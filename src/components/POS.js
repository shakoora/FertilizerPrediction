...
class POS extends Component {
    ...
    componentWillMount(){
      ...
      getChartData(){
        ...
        this.setState({
          chartData:{
            labels: ['Potassium nitrate', 'Potassium sulfate', 'Potassium chloride','Mono Potassium phosphate'],
            datasets:[
              {
                label:'kg',
                data:[
                 ...
                 <Route path="/Contact" component={Contact} />
                     <section >
                         ...
                         <article class = "texting" >
                                              < h2 > POS Predications </h2> <br/ >
                                                  <div className = "container" >
                                                      <div className = "row" >
                                                          <Chart chartData={this.state.chartData} location="potassium fertilizers" />
                                                      </div>
                                                  </div>
                                          </article>
                     </section>
